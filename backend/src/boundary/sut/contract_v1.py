"""Boundary's independent strict implementation of ADR 001 contract v1."""
...
class StrictWireModel(BaseModel):
    """Base for immutable wire objects with no silent coercion or extras."""
...
class TestRunRequest(StrictWireModel):
    ...
    def validate_paired_context(self) -> TestRunRequest:
        ...
        if (regression_values[0] is None) != (
            regression_values[1] is None
        ):
            raise ValueError(
